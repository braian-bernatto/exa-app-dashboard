  ...
  return (
    <div className='flex flex-wrap gap-20 w-full justify-evenly'>
      ...
      <article className='flex-1 h-full flex flex-col gap-10'>
        ...
        {/* llaves */}
        <div className='w-full shadow-xl h-full p-5 bg-white rounded flex-0'>
          <div className='grid grid-cols-7'>
            <div className='text-center flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-8'>
                <div className='grid grid-cols-1 grid-rows-2 gap-3 place-items-center relative'>
                  <span className='w-12 h-12 border rounded shadow relative'>
                    <Image
                  ...
                  <span className='absolute -right-10 top-[50%] w-full h-7 border-x border-t rounded-t border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
                <div className='grid grid-cols-1 grid-rows-2 gap-3 place-items-center relative'>
                  <span className='w-12 h-12 border rounded shadow relative'>
                    <Image
              ...
              <div className='grid grid-cols-1 grid-rows-4 h-full gap-8'>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  <div className='flex items-center justify-center h-full'>
                    <span className='w-12 h-12 border rounded shadow relative row-span-2'>
                      <Image
                        src={teams[0].image_url}
                        fill
                        className='object-contain'
                  ...
                  <span className='absolute -right-20 top-[50%] w-[170%] h-7 border-x border-t rounded-t border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  <div className='flex items-center justify-center h-full'>
                    <span className='w-12 h-12 border rounded shadow relative row-span-2'>
            ...
            <div className='text-center flex flex-col gap-5 z-20'>
              ...
              <div className='grid grid-cols-1 grid-rows-2 h-full gap-8'>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  ...
                  <span className='absolute -right-36 top-[50%] w-[320%] h-7 border-x border-t rounded-t border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
              </div>
            </div>
              ...
              <div className='grid grid-cols-1 h-full gap-8'>
                <div className='flex flex-col gap-3 relative'>
                  <div className='flex items-center justify-center h-full gap-2'>
                    <span className='w-12 h-12 border rounded shadow relative bg-white'>
                      <Image
                        src={teams[0].image_url}
                        fill
                        className='object-contain'
            ...
            <div className='text-center flex flex-col gap-5 z-20'>
              ...
              <div className='grid grid-cols-1 grid-rows-2 h-full gap-8'>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  <div className='flex items-center justify-center h-full'>
                    <span className='w-12 h-12 border rounded shadow row-span-2 relative'>
                      <Image
                        src={teams[0].image_url}
                        fill
                        className='object-contain'
                  ...
                  <span className='absolute -left-36 top-[50%] w-[320%] h-7 border-x border-b rounded-b border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
              </div>
            </div>
            ...
            <div className='text-center flex flex-col gap-5 z-20'>
              ...
              <div className='grid grid-cols-1 grid-rows-4 h-full gap-8'>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  ...
                  <span className='absolute -left-20 top-[50%] w-[170%] h-7 border-x border-b rounded-b border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
                <div className='row-span-2 flex flex-col gap-3 relative'>
                  <div className='flex items-center justify-center h-full'>
                    <span className='w-12 h-12 border rounded shadow row-span-2 relative'>
            ...
            <div className='text-center flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-8'>
                <div className='grid grid-cols-1 grid-rows-2 gap-3 place-items-center relative'>
                  ...
                  <span className='absolute -left-10 top-[50%] w-full h-7 border-x border-b rounded-b border-pink-800 rotate-90 translate-y-[-50%]'></span>
                </div>
                <div className='grid grid-cols-1 grid-rows-2 gap-3 place-items-center relative'>
                  <span className='w-12 h-12 border rounded shadow relative'>
                    <Image
